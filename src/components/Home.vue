...
const lyrics = [
  {
    ...
    options: [
      { name: "Aaron Burr", correct: false },
      { name: "James Madison", correct: false },
      { name: "John Laurens", correct: false },
      { name: "Eliza Hamilton", correct: true },
    ],
  ...
  },
  {
    ...
    options: [
      { name: "Eliza", correct: false },
      { name: "Peggy", correct: false },
      { name: "Angelica", correct: true },
      { name: "Maria", correct: false },
    ],
    answer: "Angelica",
  },
  {
    ...
    options: [
      { name: "Alexander Hamilton", correct: true },
      { name: "Thomas Jefferson", correct: false },
      { name: "John Laurens", correct: false },
      { name: "James Madison", correct: false },
    ],
  ...
  },
  {
    ...
    options: [
      { name: "Philip Hamilton", correct: true },
      { name: "George Eacker", correct: false },
      { name: "John Adams", correct: false },
      { name: "John Adams", correct: false },
    ],
  ...
  },
  {
    ...
    options: [
      { name: "Eliza", correct: true },
      { name: "Maria", correct: false },
      { name: "Peggy", correct: false },
      { name: "Angelica", correct: false },
    ],
    answer: "Eliza",
  },
  {
    ...
    options: [
      { name: "Lafayette", correct: true },
      { name: "Laurens", correct: false },
      { name: "Eacker", correct: false },
      { name: "Adams", correct: false },
    ],
    answer: "Lafayette",
  },
  {
  ...
  },
  {
    ...
    options: [
      { name: "Aaron Burr", correct: true },
      { name: "James Madison", correct: false },
      { name: "George Washington", correct: false },
      { name: "King George", correct: false },
    ],
    answer: "Aaron Burr",
  },
  {
    ...
    options: [
      { name: "Burr", correct: false },
      { name: "Lafayette", correct: false },
      { name: "Mulligan", correct: true },
      { name: "Laurens", correct: false },
    ],
    answer: "Mulligan",
  },
  {
    ...
    options: [
      { name: "Peggy Schuyler", correct: false },
      { name: "King George", correct: true },
      { name: "Eliza Hamilton", correct: false },
      { name: "Angelica Schuyler", correct: false },
    ],
    answer: "King George",
  },
  {
    ...
    options: [
      { name: "Peggy Schuyler", correct: true },
      { name: "King George", correct: false },
      { name: "Angelica Schuyler", correct: false },
      { name: "Eliza Hamilton", correct: false },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { name: "James Madison", correct: false },
      { name: "John Laurens", correct: false },
      { name: "George Washington", correct: true },
    ],
  ...
  },
  {
    ...
    options: [
      { name: "Burr", correct: false },
      { name: "Lafayette", correct: false },
      { name: "Mulligan", correct: false },
      { name: "Laurens", correct: true },
    ],
    answer: "Laurens",
  },
  {
  ...
  {
    lyric:
      "We will fight up close, seize the moment and stay in it. It’s either that or meet the business end of a bayonet. The code word is ‘Rochambeau,’ dig me?",
    options: [
      { name: "Hamilton", correct: true },
      { name: "Lafayette", correct: false },
      { name: "Mulligan", correct: false },
      { name: "Jefferson", correct: false },
    ],
    answer: "Hamilton",
  },
  {
    ...
    options: [
      { name: "Burr", correct: true },
      { name: "Laurens", correct: false },
      { name: "Washington", correct: false },
      { name: "Mulligan", correct: false },
    ],
    answer: "Burr",
  },
...
export default {
  ...
  data() {
    return {
      ...
      hasAnswered: false, // This checks if a question has been answered, default to false
      question: null, // This holds the current question
      options: null, // This holds the options for the current question
      correctanswer: null, // This holds the correct answer for the current question
      count: null, // This is used for a countdown timer
      players: 1, // Number of players in the game
      secondplayer: false, // This checks if there's a second player, it becomes true when players = 2
      ...
      url: null, // This holds the current URL of the game
    };
  },
  created() {
    this.fetchData();
